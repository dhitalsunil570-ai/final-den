...
// Load banner/carousel on index.html - supports multiple banners via banners_data JSON
async function loadBanner() {
  ...
  // Try banners_data (JSON array of banners set from admin)
  if (s.banners_data) {
    try {
      const parsed = JSON.parse(s.banners_data);
  ...
  // Fallback: build from banner_image1 / banner_image2 settings
  if (banners.length === 0) {
    if (s.banner_image1 || s.banner_image2 || s.banner_title) {
      if (s.banner_image1) {
        banners.push({
          image: s.banner_image1 || 'img/carousel-1.jpg',
          subtitle: s.banner_subtitle || 'Dental Care Center',
          title: s.banner_title || 'Best Dental Care For Your Family',
          text: s.banner_text || 'Professional dental services with modern equipment and experienced dentists.',
          buttonText: 'Book Appointment',
          buttonUrl: 'appointment.html'
        });
      }
      if (s.banner_image2) {
        banners.push({
          image: s.banner_image2 || 'img/carousel-2.jpg',
          subtitle: s.banner_subtitle || 'Dental Care Center',
          title: s.banner_title || 'Best Dental Care For Your Family',
          text: s.banner_text || 'Professional dental services with modern equipment and experienced dentists.',
          buttonText: 'Book Appointment',
    ...
    banners = [
      {
        ...
        title: 'Best Dental Care For Your Family',
        text: 'Professional dental services with modern equipment and experienced dentists.',
        buttonText: 'Book Appointment',
        buttonUrl: 'appointment.html'
      },
      {
        image: 'img/carousel-2.jpg',
        subtitle: 'Advanced Dental Treatment',
        title: 'Modern Dentistry For Your Bright Smile',
        text: 'State-of-the-art dental technology for the best patient care experience.',
        buttonText: 'Our Services',
        buttonUrl: 'service.html'
      }
    ];
  }
  ...
  // Init Owl Carousel after items are in DOM
  if (window.$) {
    const $c = $('.header-carousel');
...
async function loadReviews() {
  ...
  if (window.$) {
    ...
    $el.owlCarousel({autoplay:true,smartSpeed:1000,loop:true,nav:false,dots:true,items:1,autoplayTimeout:5000});
  }
}
  ...
  el.innerHTML = data.map(g => `
    <div class="col-6 col-md-6 col-lg-3 wow fadeInUp">
      <div class="gallery-item rounded overflow-hidden">
        <img src="${g.imageUrl}" class="img-fluid w-100" style="height:180px;object-fit:cover;" alt="${g.caption}">
